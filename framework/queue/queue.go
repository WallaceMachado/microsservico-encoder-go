...
type RabbitMQ struct {
	...
	ConsumerName      string
	AutoAck           bool // confirmação de recebimento da mensagem pode ser auto ou manual
	Args              amqp.Table
...
func NewRabbitMQ() *RabbitMQ {
	...
	//dead-letter-exchange paa criar uma queue que vai ler as mensagens de retorno de erro
